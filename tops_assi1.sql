...
select concat(employee_id,',',first_name,',',last_name,',',job_id,' , ',email,' , ',hire_date,' , ' ,salary,',',department_id,',')
...
select concat(ename)as  names, concat(hiredate) as start_date from emp;
...
select first_name,department_id,salary,commission_pct from employees order by salary desc;

-- 11.Display the last name and job title of all employees who do not have a manager
select last_name, job_id,manager_id from employees where manager_id is null;

-- 12.Display the last name, job, and salary for all employees whose job is sales representative or stock clerk and whose salary is not equal
-- to $2,500, $3,500, or $5,000
select last_name,job_id,salary from employees where salary != 2500;
...
WHERE e.department_id = d.department_id
	...
	AND j.job_id = e.job_idaddressaddress;
